...
# coding: utf-8
# run as:
#   Inference-RetinaNet-var.py ModelSavepath.pkl Database.sqlite DatasetName val/test [SlideDir]
...
if (len(sys.argv)<5):
    print('Syntax: Inference-RetinaNet-var.py ModelSavepath.pkl Database.sqlite DatasetName val/test [SlideDir]')
    exit()
